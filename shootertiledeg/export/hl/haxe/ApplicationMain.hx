...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("shootertiledeg", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("shootertiledeg", null, 640, 480);
		#end
		#else
		create(null);
		#end
...
>>>>>>> bcd7e95565a8b20d3be05320cb7ae3af1a3c9edc
		...
		app.meta["file"] = "shootertiledeg";
		app.meta["name"] = "shootertiledeg";
