...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("game-jam-template", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("game-jam-template", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "game-jam-template";
		app.meta["name"] = "game-jam-template";
