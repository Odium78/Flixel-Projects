...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("wizardGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("wizardGame", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "19";
		app.meta["company"] = "Odium";
		app.meta["file"] = "wizardGame";
		app.meta["name"] = "";
