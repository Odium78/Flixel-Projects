...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("shooterwizard", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("shooterwizard", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "shooterwizard";
		app.meta["name"] = "shooterwizard";
